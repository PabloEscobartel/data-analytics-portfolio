...
# -*- coding: utf-8 -*-
"""
Флаг строк, где pre value text по объему содержит формулировки верхней границы.

Ищет в `volume_gemini_pre_value_text` фразы:
- "до"
- "не больше"
- "не более"
- "не превышающий"
...
- volume_pre_upper_bound_term_flag
- volume_pre_upper_bound_term_match
"""
...
DEFAULT_SHEET = "panel"
TEXT_COLUMN = "volume_gemini_pre_value_text"
FLAG_COLUMN = "volume_pre_upper_bound_term_flag"
MATCH_COLUMN = "volume_pre_upper_bound_term_match"
PATTERN = re.compile(r"(?iu)(\bдо\b|не\s+больше|не\s+более|не\s+превышающ\w*)")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Flag pre value texts with upper-bound volume terms.")
